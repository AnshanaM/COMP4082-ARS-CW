...
# Select the environment: "CartPole-v1" or "MountainCar-v0"
...
# Reward range for each environment
if env_id == "CartPole-v1":
    reward_inf, reward_sup = 0, 100
elif env_id == "MountainCar-v0":
    reward_inf, reward_sup = -200, 0
...
for i in range(5):  # Train for 5 independent runs
    ...
    for frame_idx in range(1, num_frames + 1):
        ...
        if len(replay_buffer) > batch_size:
            ...
            td_errors, loss, sigma_loss = improved_td_loss(
