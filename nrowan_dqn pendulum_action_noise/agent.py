...
from original_nrowandqn import ACTION_NROWANDQN
...
current_model = ACTION_NROWANDQN(env.observation_space.shape[0], env.action_space.shape[0], env).to(device)
# initialise target Q-net
target_model  = ACTION_NROWANDQN(env.observation_space.shape[0], env.action_space.shape[0], env).to(device)
