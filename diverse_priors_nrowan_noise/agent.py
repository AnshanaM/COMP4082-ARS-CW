...
current_model = ACTION_NROWANDQN(env.observation_space.shape[0], env.action_space.n, env).to(device)
# initialise target Q-net
target_model  = ACTION_NROWANDQN(env.observation_space.shape[0], env.action_space.n, env).to(device)
